      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 rounded-xl border border-zinc-700 bg-zinc-800 hover:bg-zinc-700 px-4 py-3 text-sm font-medium text-zinc-300 hover:text-white transition-all mb-6 disabled:opacity-50"
          >
